...
- [x] Create UI components for displaying notes.
...
- [x] Design database schema for memories.
- [x] Set up Supabase storage for images.
- [x] Implement API route for uploading images.
- [x] Create UI components for displaying images.
- [x] Build a form for uploading new memories.
- [x] Add functionality to delete memories.
